...
$payload = Array(
    'purpose' => 'testing',                            // purpose of payment
    'amount' => '25',                                 // amount of payment
    'phone' => '7668711341',                          // ph.num
    'buyer_name' => 'yashasvi',                      // buyername
    'redirect_url' => 'http://localhost/instamojo/success.php',       // where to redirect user
    'send_email' => true,                              // sending mail
    'webhook' => '',  // ienter your webhook url
    'send_sms' => true,
    'email' => 'yashasvipundeer@gmail.com',                   // email address
